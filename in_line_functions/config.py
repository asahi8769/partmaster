...
additional_exceptions = ['AA', 'AB', 'ACCORDING', 'ACID', 'ACTR', 'ACU', 'ACUTATOR', 'AFTER', 'XCIENT', 'KD', 'EHJ',
                         ...
                         'FCAR', 'FILR', 'FOIL', 'FOLD', 'FULE', 'GRAY', 'HTCV', 'IPDN', 'LATE', 'RSVR', 'SBMP', 'SELT',
                         'STAB', 'STAT', 'LH혼입', 'LING', 'MLDH', 'M미승인', 'OPRS', 'QSSY', 'QTMP', 'QZMP', 'REFL',
                         'TACK', 'TAKE', 'TEST', 'TION', 'ZEDO', '上海宝隆', '不良通报', '产品划伤', '产品受潮', '产品变形', '产品异种', '产品污染',
                         '产品油斑', '产品生锈', '产品碰伤', '产品锈斑', '入库不良', '入库变形', '划伤不良', '前后混装', '包装不良', '包装变形', '包装淋湿', '包装破损',
                         '北京万都', '北京世东', '北京大圆', '北京大有', '卡扣不良', '外观不良', '天津平和', '天津立中', '天津锦湖', '容易撕裂', '山东真元', '工程不良',
                         '异种不良', '打磨变形', '托盘变形', '托盘破损', '护角移位', '数量不足', '数量异种', '月捷喜爱', '每日不良', '气泡不良', '江苏大起', '涂装不良',
                         '涂装修补', '红点点反', '缺失配件', '色线不良', '色线磨损', '表面损伤', '表面破损', '轮毂压痕', '轮胎破损', '轮辋开裂', '部件生锈', '部品异种',
                         '部品碰伤', '钢印不良', '铸造不良', '青岛东亚', '青岛东和', '风孔不良', '风孔焊渣', '龙口星宇', 'AI', 'A면',
                         'B골', 'CS', 'DW', 'EA', 'ED', 'EG', 'FD', 'GA', 'GD', 'HD', 'HF', 'HL', 'HT', 'HV', 'IB', 'IP',
                         'IR', 'JC', 'JD', 'KM', 'LD', 'LF', 'LM', 'LT', 'MP', 'NP', 'NX', 'N단', 'PD', 'PH', 'PO', 'PQ',
